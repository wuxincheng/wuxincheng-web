...
<body>
	...
	<div id="ckepop">
	<a class="jiathis jiathis_txt jtico jtico_jiathis">分享到：</a>
	...
	<div class="ya2dan-container">
		<div class="hero-unit">
			<p>
			<h5>腾讯、新浪、微信、Facebook、Google+、Twitter</h5>
			<a href="#" class="btn btn-danger btn-lg" role="button"><span class="icon-share icon-white"></span> Share</a>
			<h6>腾讯：http://connect.qq.com</h6>
			<h6>加网：http://www.jiathis.com</h6>
			<h6>新浪：http://open.weibo.com/widget/like.php</h6>
			<h6>脸书：https://developers.facebook.com/docs/plugins/like-button</h6>
			<h6>https://www.addthis.com</h6>
			
			<hr>
			<p>
			<jsp:include page="share/qq.jsp" />
			</p>
			
			<form action="<%=request.getContextPath()%>/settleFile/process" method="post">
			</form>
